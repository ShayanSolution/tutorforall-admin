<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="{{route('dashboard')}}" class="waves-effect"><i class="ti-dashboard p-r-10"></i> <span class="hide-menu">Dashboard</span></a> </li>
            ...
            <li> <a href="#" class="waves-effect"><i class="icon-people p-r-10"></i> <span class="hide-menu"> Tutors <span class="fa arrow"></span></span></a>
                <ul class="nav nav-second-level">
                    ...
                    <li> <a href="{{route('tutorsDisbursements')}}">Disbursements</a> </li>
                    <li><a href="{{route('tutorsRevenue')}}">Revenue Reports</a></li>
                    {{--<li> <a href="#">Edit Professor</a> </li>--}}
                    {{--<li> <a href="#">Professor Profile</a> </li>--}}
                </ul>
            </li>
